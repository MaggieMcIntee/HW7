...
class Cohort:
    ...
    def cohortsurvivalresults(self):
        self._yearsalive = 0
        for i in self._survivalTimes:
            if i > 5:
                self._yearsalive += 1
        return self._yearsalive/len(self._survivalTimes)

    def fiveyearmarksurvival(self):
        self._countifsurvive = 0
        for i in self._survivalTimes:
            if i > 5:
                self._countifsurvive += 1
        return self._countifsurvive/len(self._survivalTimes)
